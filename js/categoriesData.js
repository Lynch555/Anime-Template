const categoriesData = () => {
  ...
  // Создаем функцию которая получит массив данных и перебрав его выведет в виде карточек в кантейнер(Тот самый кантейнер который хранит в себе самые просматриваемые анимею)
  ...
  fetch('./db.json')
    ...
    .then((data) => {
      ...
      // фильтруем данные, используем метод slice и отфильтруем от большего к меньшему.
